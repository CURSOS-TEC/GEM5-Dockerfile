...
# -- Variable dependiente: system.cpu.dcache.writebacks::total 
...
export META_YAXIS="system.cpu.dcache.writebacks::total"
export META_CPU_TYPE=TimingSimpleCPU
export META_FOLDER_NAME=test6
export META_WORK_DIR=/home/SharedData/test6/
...
do
    ...
    yValue=$(cat "./${META_FOLDER_NAME}/m5out${testIndex}/stats.txt" | awk -F "=" '/system.cpu.dcache.writebacks::total / {print $0}' | awk -F " " '{print $2}')
    yAxis[${#yAxis[@]}]="${yValue}"
done
