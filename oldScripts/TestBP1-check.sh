...
export META_XAXIS="localPredictorSize"
export META_YAXIS="system.cpu.branchPred.BTBLookups"
export META_CPU_TYPE=TimingSimpleCPU
export META_FOLDER_NAME=testBP11
export META_WORK_DIR=/home/SharedData/testBP11
...
do
    echo "Iteración BTB entries $((testIndex*8))"
    sed -i "62s/.*/    BTBEntries = Param.Unsigned($((testIndex*8)), \"Number of BTB entries\")/" /code/GEM5/gem5/src/cpu/pred/BranchPredictor.py
